...
## Shared leadership
The Lab for Neuroimaging and Neuroinformatics (LNN) @ UCPH is led by two senior researchers, [Assoc. Professor Melanie Ganz-Benjaminsen](https://researchprofiles.ku.dk/en/persons/melanie-ganz-benjaminsen/) and [Asst. Professor Martin Nørgaard](https://researchprofiles.ku.dk/en/persons/martin-n%C3%B8rgaard/). We believe that good science and research is inherently interdisciplinary and that we can drive science further when we work and collaborate with others. Therefore we have chosen to lead the lab together - one of us focusing a bit more on neuroimaging and the other on neuroinformatics.
