...
## Shared leadership
The Lab for Neuroimaging and Neuroinformatics (LNN) @ UCPH is led by two senior researchers, Assoc. Professor Melanie Ganz-Benjaminsen and Asst. prof. Martin Nørgaard. We believe that good science and research is inherently interdisciplinary and that we can drive science further when we work and collaborate with others. Therefore we have chosen to lead the lab together - one of us focusing a bit more on neuroimaging and the other on neuroinformatics.
